...
DROP FUNCTION IF EXISTS generate_nanoid (int, text, float);

CREATE
OR REPLACE FUNCTION generate_nanoid (
  size int DEFAULT 21, -- The number of symbols in the NanoId String. Must be greater than 0.
  alphabet text DEFAULT '_0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', -- The symbols used in the NanoId String. Must contain between 1 and 255 symbols.
...
CREATE
OR REPLACE FUNCTION nanoid_optimized (
